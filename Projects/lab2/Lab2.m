clear
%%
%The striking mechanism of a weaving machine consists of a four bar linkage. In a particular case, such a linkage is required to coordinate five positions of the rocker follower
%with five positions of the input crank as shown in the Table 1. The length of the fixed
%link is required to be 180mm.
%%
